  ...
  return (
    <div className="flex justify-center pt-20 pb-20">
      <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
        <Link className="flex items-center text-center mx-auto">
          <img src={logo} className="h-12 mr-3" alt="" />
          <span className="self-center text-3xl font-bold whitespace-nowrap dark:text-white">
            Fitness Hub
          </span>
        </Link>
        <h4 className="block text-center font-sans text-2xl font-semibold leading-snug tracking-normal text-blue-gray-900 antialiased mb-10">
          Sign Up
        </h4>
        ...
        >
          ...
          <p className=" flex items-center mt-5">
            <p className="border-t-4 w-1/2"></p>
            <p>Or</p>
            <p className="border-t-4 w-1/2"></p>
          </p>
        </form>
