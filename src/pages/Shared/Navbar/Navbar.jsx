...
//         </li>
//       ) : (
//         <li className="block px-4 py-2 text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
...
//               ) : (
//                   <Link to='/login'>
//                   <button className="px-6 rounded bg-[#A1F65E] py-3 text-xl">Login</button>
//                   </Link>
//               )}
//             </button>
